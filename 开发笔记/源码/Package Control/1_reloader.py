...
st_build = int(sublime.version()) # sublime_build = int('3211')


mod_prefix = 'package_control' # 模块前缀 = 'package_control'
# ST3 是SublimeText3的缩写
# ST3 把所有包都当成模块来加载，所以为了和普通模块区分，要在每个包前面加上'package_control'前缀
if sys.version_info >= (3,):
